...
v1 = diagram.vertex(xy=(.50,.75), marker='')
v2 = diagram.vertex(xy=(.50,.25), marker='')
t1 = diagram.vertex(xy=(.65,.75), marker='')
t2 = diagram.vertex(xy=(.65,.25), marker='')

w1 = diagram.vertex(xy=(.85,.85), marker='')
b1 = diagram.vertex(xy=(.85,.55), marker='')
w2 = diagram.vertex(xy=(.85,.15), marker='')
b2 = diagram.vertex(xy=(.85,.45), marker='')

q1 = diagram.line(in1, v1,style='loopy',nloops=7,yamp=0.02)
q2 = diagram.line(v2, in2,style='loopy',nloops=7,yamp=0.02)
g = diagram.line(v1, v2,arrow=False)
top1 = diagram.line(v2, t2,arrow = False)
top2 = diagram.line(t1,v1,arrow = False)
...
q1.text("g",t=0.5,y=-0.1,fontsize=30)
q2.text("g",t=0.5,y=-0.1,fontsize=30)
g.text("",t=0.5,y=0.1,fontsize=30)
...
plt.savefig('topquark-gg2.eps', format='eps')
